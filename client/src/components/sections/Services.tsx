...
export const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-36 bg-white border-y border-brand-border relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-xl">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-brand-text-heading tracking-tight">
              Modular Data Services Tailored for Enterprise Performance
            </h2>
          </div>
          <p className="text-brand-text-body font-medium text-sm md:max-w-xs leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((svc, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="group border border-brand-border bg-brand-offwhite/10 p-8 flex flex-col justify-between transition-all duration-300 ease-in-out hover:border-brand-teal hover:bg-white hover:shadow-xl hover:scale-[1.01] hover:-translate-y-1.5 min-h-[360px]"
              >
                <div>
                  {/* Icon Block */}
                  ...
                  {/* Title */}
                  <h3 className="text-lg font-bold text-brand-text-heading mb-3 group-hover:text-brand-teal transition-all">
                    {svc.title}
                  </h3>
                ...
                {/* Sub points list */}
                <div>
                  <ul className="space-y-2 border-t border-brand-border pt-4 mb-4">
                  ...
                  <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-brand-teal mt-4 opacity-70 group-hover:opacity-100 transition-opacity">
